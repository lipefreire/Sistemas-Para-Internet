...
public class AppObject {
	public static void main(String[] args) {
		VetorObject vetor3 = new VetorObject(5);
		
		vetor3.adiciona("SALVADOR");
		vetor3.adiciona("2.3");
		vetor3.adiciona("BARREIRAS");
		vetor3.adiciona(2);
		vetor3.adiciona(true);
		
		System.out.println(vetor3.imprime());
		...
		System.out.println(vetorAlunos.imprime());
	}
}
